...
Summary(pl):	LibTomMath - procedury do zastosowañ teorii liczb z zakresu liczb ca³kowitych
Name:		libtommath
Version:	0.39
Release:	1
...
wiêkszo¶ci zastosowañ teorii liczb z zakresu liczb ca³kowitych
(w³±cznie z kryptografi± klucza publicznego). LibTomMath jako taka
nie jest zestawem procedur kryptograficznych, ale mo¿e byæ u¿yta do
napisania takowego (jest u¿ywana w LibTomCrypt do procedur klucza
publicznego RSA, DH i ECC).

%package devel
Summary:	Header files for LibTomMath library
Summary(pl):	Pliki nag³ówkowe biblioteki LibTomMath
...
Pliki nag³ówkowe biblioteki LibTomMath.
